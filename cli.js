...
case 'init': {
  ...
  const starterSrc = path.join(templatesDir, 'starter');
...
Tips:
- Run "ax init starter" in a new/empty folder to scaffold a starter project.
- All templates are inside the "templates/" directory.
- For more info, visit: https://github.com/creativitas-dev/axcora-ax
`);
}
